...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            int val = Emps.Max(e => e.Salary);
            return Emps.Where(e => e.Salary == val);
        }
        ...
        {
            var deptWithEmpCounts = Depts.GroupJoin(Emps, d => d.Deptno, e => e.Deptno,
                                                   (d, e) => new { Dept = d, EmpCount = e.Count() });

            return deptWithEmpCounts
